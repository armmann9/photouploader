            ...
            <div>
              <div className="flex items-center gap-3 mb-3">
                <img
                  src={member.avatar}
                  alt={member.name}
                  className="w-13 h-13 rounded-2xl object-cover border-2 border-amber-400/60 shadow-sm"
                />
                <div>
                  ...
                  <span className="inline-block mt-0.5 px-2 py-0.5 rounded-md bg-emerald-900/80 text-[10px] font-bold text-amber-400 border border-emerald-700">
