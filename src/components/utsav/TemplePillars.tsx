...
export const TemplePillars: React.FC<TemplePillarsProps> = ({ 
  ...
  return (
    <>
      ...
      <div 
        className="pointer-events-none fixed top-0 left-0 bottom-0 z-30 hidden sm:block w-14 md:w-20 lg:w-24 xl:w-28 h-screen"
        style={{
      ...
      <div 
        className="pointer-events-none fixed top-0 right-0 bottom-0 z-30 hidden sm:block w-14 md:w-20 lg:w-24 xl:w-28 h-screen"
        style={{
